...
/**
 * 章のあいだに挟む区切りページ。
 * before に指定した章の直前に入る。話題が大きく変わる場所だけに置き、
 * 「ここから何の話になるのか」を先に渡してから本編に入る。
 */
export const interludes = [
  {
    before: 'history',
    eyebrow: 'ここからは — 来歴',
    lines: ['仕組みは、', '80年かけて', 'ここへ来た。'],
    lede: '1943年の形式ニューロンから、2026年のエージェントまで。誰が、どの順番で、何を積み上げたのか。',
  },
  {
    before: 'compute',
    eyebrow: 'ここからは — 土台と産業',
    lines: ['モデルは、', 'ひとりでは', '動かない。'],
    lede: '半導体、クラウド、そして蒸留。AIを成り立たせている土台と、その上に積み上がった産業の層。',
  },
  {
    before: 'agents',
    eyebrow: 'ここからは — 使い方',
    lines: ['選んだあとの', '使い方で、', '結果は変わる。'],
    lede: '1往復のチャットか、回り続けるループか。そして、どこまで開くのか。',
  },
  {
    before: 'regions',
    eyebrow: 'ここからは — 世界とのぶつかり方',
    lines: ['技術は、', '世界と', 'ぶつかる。'],
    lede: '地図、法廷、戦場、そして条約。ここからは、AIが現実の制度と衝突している場所の話。',
  },
];
